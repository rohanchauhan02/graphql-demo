...
const (
	...
	UserService_UpdateUser_FullMethodName = "/userpb.UserService/UpdateUser"
...
type UserServiceClient interface {
	...
	// Mutations
	Register(ctx context.Context, in *CreateUserInput, opts ...grpc.CallOption) (*AuthResponse, error)
...
func (c *userServiceClient) Register(ctx context.Context, in *CreateUserInput, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) Login(ctx context.Context, in *LoginInput, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type UserServiceServer interface {
	...
	// Mutations
	Register(context.Context, *CreateUserInput) (*AuthResponse, error)
...
func (UnimplementedUserServiceServer) Register(context.Context, *CreateUserInput) (*AuthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedUserServiceServer) Login(context.Context, *LoginInput) (*AuthResponse, error) {
...
func _UserService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Register(ctx, req.(*CreateUserInput))
	}
	return interceptor(ctx, in, info, handler)
}
